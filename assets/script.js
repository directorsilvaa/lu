...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "10/02": titulo = "10 de Fevereiro de 2021"; mensagem = "<p>O DIA QUE ELA DISSE SIM </p>";break;
            case "31/12" : titulo = "o dia que se connectamos "; mensagem = "<p>o dia";break;
            case "final": titulo = " 10  de fevereiro de 2023"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que ela disse<br><span class='letra2 letra-vermelha'>SIM</span></strong></p></section>";break;
        }
